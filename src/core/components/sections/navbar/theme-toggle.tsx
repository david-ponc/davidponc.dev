...
export function ThemeToggle({ initialValue }: { initialValue: string }) {
	...
	return (
		<Menu.Root open={open} onOpenChange={setOpen}>
			<Menu.Trigger className='not-disabled:cursor-pointer p-1 text-muted-foreground transition-colors not-disabled:hover:text-brand-a focus-visible:text-brand-a hover:[anchor-name:--social-anchor] focus-visible:[anchor-name:--social-anchor]'>

...
import type { SecondaryProject as SecondaryProjectType } from '~/types';

import styles from './secondary-project.module.css';

interface ProjectProps extends SecondaryProjectType {}
...
export const SecondaryProject = ({
	...
	return (
		<article className={styles.project} {...props}>
			<Link href={repository} className={styles.title}>
				{title}
			</Link>
			...
			<footer className={styles.links}>
				<Link href={deploy} className={styles.link}>
